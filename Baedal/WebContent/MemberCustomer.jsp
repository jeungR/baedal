...
<div class="testbox">
  ...
  <input type="password" name="pwcheck" id="name" placeholder="Password확인" required/>
  <input type="text" name="mobile" id="name" placeholder="핸드폰번호" required/>
  <input type="text" name="address" id="name" placeholder="주소" required/>
  <br>
    <hr>
  <div class="gender">
    <input type="radio" value="None" id="male" name="gender" />
    <label for="male" class="radio" chec>문자를 통한 정보수신에 동의 합니다. (필수)</label>
   </div> 
